    ...
    <div className='p-7 h-screen flex flex-col justify-between'>
      <div>
        ...
        <form onSubmit={submitHandler}>
          ...
          <button className='bg-[#111] text-white font-semibold mb-12 rounded px-4 py-2 w-full text-lg'>
            Create account
          </button>
        </form>

        <p className='text-center'>
          Already have an account? <Link to='/UserLogin' className='text-blue-600'>Login here</Link>
        </p>
      </div>
    </div>
  )
